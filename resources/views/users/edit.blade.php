...
<head>
    ...
    <title>EDIT USER - Tutorial CRUD Laravel 12 @ qadrlabs.com</title>
            ...
            <form action="{{ route('user.update', $user) }}" method="POST">
                ...
                <div class="mb-5">
                  ...
                  "
                        ...
                        value="{{ old('neighborhoodAssociation', $user->neighborhoodAssociation) }}" readonly>
                ...
                <div class="mb-5">
                    ...
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                  "
                        name="dasaWisma" value="{{ old('dasaWisma', $user->dasaWisma) }}" required>
                ...
                <div class="mb-5">
                    ...
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                  "
                        name="couponNumber" value="{{ old('couponNumber', $user->couponNumber) }}" required>
